  ...
  do
  {
    ...
    do
    {
      ...
      if (strcmp(G, "A") !=0  &&
                            ...
                            strcmp(G, "AB") !=0   &&
                            strcmp(G, "O") !=0 )
        printf("Blood group %s is incorrect! Please try again and if it doesn't work try another time.\n", G);
    }  while (strcmp(G, "A") !=0  &&
                            strcmp(G, "B") !=0  &&
                            strcmp(G, "AB") !=0   &&
                            strcmp(G, "O") !=0 );
    ...
    else if (strcmp(G, "AB") == 0)
    {
      ...
      printf("  Wow, you can receive blood from everybody: O, A, B, AB.\n");
    }
    else
    {
      printf("%s, O. Nice! You can give blood to everybody: O, A, B, AB\n", Name);
